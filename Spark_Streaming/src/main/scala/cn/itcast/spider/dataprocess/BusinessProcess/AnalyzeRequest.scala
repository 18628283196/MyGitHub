...
import cn.itcast.spider.common.bean.{AnalyzeRule, QueryRequestData, RequestType}
import cn.itcast.spider.common.util.decode.RequestDecoder
import cn.itcast.spider.common.util.json.JsonPathParser
