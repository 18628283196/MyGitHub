...
import cn.itcast.spider.common.bean.{AnalyzeRule, BookRequestData, RequestType}
import cn.itcast.spider.common.util.decode.{MD5, RequestDecoder}
import cn.itcast.spider.common.util.json.JsonParser
import cn.itcast.spider.common.util.xml.xmlUtil
import cn.itcast.spider.dataprocess.constants.FlightTypeEnum
import cn.itcast.spider.dataprocess.constants.TravelTypeEnum.TravelTypeEnum
