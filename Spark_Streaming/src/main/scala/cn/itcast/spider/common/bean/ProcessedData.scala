package cn.itcast.spider.common.bean

import cn.itcast.spider.dataprocess.constants.BehaviorTypeEnum.BehaviorTypeEnum
import cn.itcast.spider.dataprocess.constants.FlightTypeEnum.FlightTypeEnum
