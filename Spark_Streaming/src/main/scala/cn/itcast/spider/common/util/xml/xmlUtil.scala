package cn.itcast.spider.common.util.xml

import java.io.StringReader

import cn.itcast.spider.common.bean.{AnalyzeRule, BookRequestData}
import cn.itcast.spider.dataprocess.constants.TravelTypeEnum
